        ...
        <div className="hidden flex-col md:flex">
            <div className="border-b">
                <div className="flex h-16 items-center px-4">
                    <h2 className="text-2xl font-bold tracking-tight">Generate app, add modules & configure them.</h2>
                </div>
            </div>
            <div className="flex-1 space-y-4 p-8 pt-6">
                <h2 className="font-bold tracking-tight">Selected app:</h2>
                {selectedApp === null ? <p>No app selected</p> : <p>{selectedApp?.id} {selectedApp?.name}</p>}

                <h2 className="font-bold tracking-tight">Select path where the app should be located:</h2>
                ...
                <h2 className="font-bold tracking-tight">Generate app:</h2>
                <div className="flex items-center space-x-2">
                    <Button disabled={
                        (selectedApp !== null) &&
